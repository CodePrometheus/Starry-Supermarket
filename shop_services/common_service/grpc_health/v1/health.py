...
from shop_services.common_service.grpc_health.v1 import health_pb2 as _health_pb2
from shop_services.common_service.grpc_health.v1 import health_pb2_grpc as _health_pb2_grpc
        ...
        with self._lock:
            if self._gracefully_shutting_down:
                ...
                if service in self._send_response_callbacks:
                    for send_response_callback in self._send_response_callbacks[service]:
                        send_response_callback(
                            _health_pb2.HealthCheckResponse(status=status))
